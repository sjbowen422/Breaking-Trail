...
with tab2:
    ...
    st.write("A call option gives the buyer the right to buy a stock at the strike price. Buyers want the stock to go **up**.")

    st.subheader("Put Option")
    st.write("A put option gives the buyer the right to sell a stock at the strike price. Buyers want the stock to go **down**.")

    st.subheader("Strike Price")
    st.write("The price at which the option contract allows you to buy or sell the stock.")

    st.subheader("Expiration Date")
    st.write("The final day the option contract is valid.")

    st.subheader("Premium")
    st.write("The cost of the option — what the buyer pays and the seller receives.")

    st.subheader("Intrinsic vs Extrinsic Value")
    st.write("""
